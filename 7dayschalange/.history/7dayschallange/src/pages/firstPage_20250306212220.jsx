...
const MonthlyYerlyCard = styled(Box)(({ theme, selected }) => ({
  padding: theme.spacing(1),
  borderRadius: 4,
  flex: 1,
  // border: selected ? "1px solid #544e98" : "1px solid #ccc",
...
const CustomStyledSwitch = styled(Switch)(({ theme }) => ({
  ...
  "& .MuiSwitch-switchBase.Mui-checked + .MuiSwitch-track": {
    backgroundColor: "#172b4d", // Color when switched ON
    opacity: 1,
  },

  "& .MuiSwitch-switchBase + .MuiSwitch-track": {
    backgroundColor: "#172b4d", // Color when switched OFF
  },
}));
          ...
          <Box>
            ...
            <FormControl component="fieldset" sx={{ width: "100%", mt: 3 }}>
              <RadioGroup
                ...
                sx={{ display: "flex", flexDirection: "row", gap: "1px" }}
              >
                <FormControlLabel
                  value="arcade"
            ...
            <Box>
              <MonthlyYerlyCard>
                ...
                <FormControlLabel
                  control={<CustomStyledSwitch defaultChecked />}
                />
                <Typography color="textSecondary" paragraph>
                  Yearly
                </Typography>
