          ...
          <Box>
            ...
            <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
              <FormControlLabel
                control={
                  <PickCheckBox
                    checked={formData.pickArray.includes("online-service")}
                    onChange={(e) => {
                      const newPickArray = [...formData.pickArray];
                      if (e.target.checked) {
                        newPickArray.push("online-service");
                      } else {
                        const index = newPickArray.indexOf("online-service");
                        if (index > -1) {
                          newPickArray.splice(index, 1);
                        }
                      }
                      setFormData({
                        ...formData,
                        pickArray: newPickArray,
                      });
                    }}
                  />
                }
              ...
              />
              <AddOnsCard
                selected={formData.pickArray.includes("online-service")}
                onClick={() => {
                  const newPickArray = [...formData.pickArray];
                  if (newPickArray.includes("online-service")) {
                    const index = newPickArray.indexOf("online-service");
                    newPickArray.splice(index, 1);
                  } else {
                    newPickArray.push("online-service");
              ...
              >
                ...
                >
                  ...
                  <Typography sx={{ alignSelf: "center", color: "#544e98" }}>
            ...
            {/* You can add more add-ons following the same pattern */}
          </Box>
        );
      case 3:
        return (
